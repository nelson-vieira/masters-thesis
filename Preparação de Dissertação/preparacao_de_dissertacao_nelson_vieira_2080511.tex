...
differential privacy such as Google's box blurring algorithm \cite{} that is
used in the map's street view, Microsoft's Visor \cite{} which is a video-analytics-as-a-service
tool, Shokri and Shmatikov's \cite{} system for collaborative deep learning, but
these algorithms suffer from heavy computational overhead, inner attacks, or
nonprovable privacy.
...
proofs, and anonymous credentials in crowdsensing. In addition, crowdsourcing
was used to create a machine learning model for parking recognition in the

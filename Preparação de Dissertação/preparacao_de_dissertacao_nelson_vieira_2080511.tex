...
\textbf{\color{red}redo these three paragraphs}

Kühtreiber et al. SLR \cite{Kuhtreiber2022survey} analyses what tools are available for
...
their actions online regarding privacy. Skirpan et al. \cite{SkirpanPrivacy} built
...
otherwise privacy rights won't be respected if they are not enforceable
...
users without many restriction in order to increase their profit margins.

\subsubsection{Privacy through security}

Sun et al. \cite{SunSecure} design a lightweight communication strategy for the
remote-control system in this work, employing two types of Virtual-Spaces to
achieve the aim of identity announcement and data exchange


constructed a prototype system of the scheme and tested
it on the Freenet, demonstrating that the method can effectively resist the influence
of flow analysis on communication anonymity while preserving communication data security.

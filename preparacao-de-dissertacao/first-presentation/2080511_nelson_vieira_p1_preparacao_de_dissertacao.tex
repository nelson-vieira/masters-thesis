...
\put(532,-390.75){\includegraphics[width=386.1251pt,height=201.75pt]{images/nsa_files.png}}
\put(39,-345.1251){\includegraphics[width=304.5pt,height=100.125pt]{images/wikileaks.png}}
\put(378,-395.75){\includegraphics[width=201.75pt,height=201.75pt]{images/anonymous.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\begin{picture}(-5,0)(2.5,0)
\put(78.60001,-112.2741){\fontsize{48}{1}\selectfont\color{color_93343}Privacidade online}
\put(172,-361.75){\includegraphics[width=178.375pt,height=56.75pt]{images/https.png}}
\put(445,-431.25){\includegraphics[width=334.8749pt,height=282.25pt]{images/cookies_example.png}}
\put(175,-237.75){\includegraphics[width=169.25pt,height=56.75pt]{images/gdpr.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\put(487,-416.1249){\includegraphics[width=281.25pt,height=281.1249pt]{images/kevin_ashton.png}}
\put(178,-422.1251){\includegraphics[width=186.375pt,height=281.1251pt]{images/mark_weiser.png}}
...
\put(96,-483.75){\includegraphics[width=465.5pt,height=316.75pt]{images/iotnetworks.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\put(547,-463){\includegraphics[width=262.125pt,height=321pt]{images/privacy_paradox.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\put(467,-429.6251){\includegraphics[width=416.25pt,height=261.6251pt]{images/privacy_assistant_example.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\put(388,-449.75){\includegraphics[width=503.5pt,height=316.75pt]{images/lteye.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);
...
\put(105,-465.5){\includegraphics[width=734.25pt,height=298.5pt]{images/iot_assistant.png}}
\end{picture}
\newpage
\begin{tikzpicture}[overlay]
\path(0pt,0pt);

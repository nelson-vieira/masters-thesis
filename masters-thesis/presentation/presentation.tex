        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot coordinates {(1,0) (2,0) (3,1.48) (4,2.96) (5,7.41) (6,17.04) (7,71.11)};
                \end{axis}
            \end{tikzpicture}
            \caption{}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot coordinates {(IoT,22.22) (Ubicomp,4.44) (PA,13.33) (Blockchain,11.11)};
                    \addlegendentry{{\tiny Very knowledgable}}
                    \addplot coordinates {(IoT,37.78) (Ubicomp,28.89) (PA,28.89) (Blockchain,44.44)};
                    \addlegendentry{{\tiny Some knowledge}}
                    \addplot coordinates {(IoT,40) (Ubicomp,66.67) (PA,66.67) (Blockchain,44.44)};
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot coordinates {(14.44,Disagree) (18.33,Do not know) (67.22,Agree)};
                \end{axis}
            \end{tikzpicture}
            \caption{}

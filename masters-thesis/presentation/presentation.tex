...
\begin{frame}
    \begin{figure}
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    every node near coord/.append style={rotate=80, anchor=west, font=\small},
                    legend style={at={(0.5,-0.1)},anchor=north}
                ]
                    \addplot[blue!20!black,fill=blue!70!white] coordinates {(1,0) (2,0) (3,1.48) (4,2.96) (5,7.41) (6,17.04) (7,71.11)};
                \end{axis}
            \end{tikzpicture}
            \caption{}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    legend style={at={(0.99,0.90)},anchor=south}
                ]
        ...
        \end{subfigure}
        \caption{Participant responses regarding: (a) privacy importance and (b) IT knowledge.}
        \label{fig:survey_responses_1}
    \end{figure}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[yellow!10!black,fill=yellow!70!white] coordinates {(14.44,Disagree) (18.33,Do not know) (67.22,Agree)};
                \end{axis}
            \end{tikzpicture}
            \caption{}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[purple!20!black,fill=purple!70!white] coordinates {(1,0) (2,0) (3,1.48) (4,2.96) (5,7.41) (6,17.04) (7,71.11)};
                \end{axis}
            \end{tikzpicture}
            \caption{}
            \label{fig:survey_privacy_importance2}
        \end{subfigure}
        \caption{Participant responses regarding: (a) willingness to read privacy notices and (b) IoT usage.}
        \label{fig:survey_responses_2}
    \end{figure}
\end{frame}

...
\begin{frame}
    \begin{figure}
        ...
        \end{subfigure}
        \caption{{\small Participant responses regarding: (a) participants' privacy importance perception and (b) general IT knowledge.}}
...
\begin{frame}
    \begin{figure}
        ...
        \begin{subfigure}[t]{0.45\textwidth}
                \begin{tikzpicture}
                    \begin{axis}[
                        ...
                        nodes near coords={\pgfmathprintnumber\pgfplotspointmeta\%},
                        legend style={at={(0.8,0.63)},anchor=north}
                    ]
                        \addplot[lime!20!black,fill=lime!60!white] coordinates {(33.33,No) (66.67,Yes)};
                        \addlegendentry{{\scriptsize Internet of Things usage}}
                        \addplot[violet!20!black,fill=violet!70!white] coordinates {(64.44,No) (35.56,Yes)};
                        \addlegendentry{{\scriptsize Internet of Things device at home}}
                    \end{axis}
                \end{tikzpicture}
                \caption{}
        ...
        %             legend style={at={(0.5,-0.1)},anchor=north}
        %         ]
        %             \addplot[purple!20!black,fill=purple!80!white] coordinates {(1,0) (2,0) (3,1.48) (4,2.96) (5,7.41) (6,17.04) (7,71.11)};
        %         \end{axis}
        %     \end{tikzpicture}
        %     \caption{}

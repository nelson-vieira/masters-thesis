...
% TODO: better integrate this part into the text
...
Privacy has become such an important concern in the information age in which
we live because most computer/technology/web organizations heavily rely on
the advertising sector, which in turn depends on customer data. Following the
2000s, many organizations offered their services to the general public without
charging a fee. However, because these organizations depend on revenue to
stay afloat, the customer is ultimately treated as a commodity for their data

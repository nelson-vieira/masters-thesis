    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                % \addlegendentry{\textcolor{red}{TOFIX} Are you interested in finding out more about regulations or legislation related to digital privacy?}
                \addplot coordinates {(1,11.11) (2,2.22) (3,4.44) (4,44.44) (5,17.78) (6,11.11) (7,8.89)};
                % \addlegendentry{\textcolor{red}{TOFIX} "My data was more protected after the implementation of regulations such as the General Data Protection Regulation."}
            \end{axis}
        \end{tikzpicture}
...
Figure \ref{fig:privacy_notices} depicts questions related to privacy notices.
...
and 6.67\% said they always do, as demonstrated on Figure \ref{fig:creating_account_false_data}.
...
unknown to most respondents, it is known only to those that have certain
qualifications or who work in IT or similar areas.
...
performed all tasks, using this system a median score of 92,33\% was achieved.
This is a high score which would mean that the application provides
...
%                 nodes near coords={\pgfmathprintnumber\pgfplotspointmeta\%}
%             ]
%             \addplot[scatter, only marks] coordinates {(1,85) (2,90) (3,91.66666667) (4,96.66666667) (5,98.33333333) (6,93.33333333) (7,63.33333333)};
%             \end{axis}
%         \end{tikzpicture}

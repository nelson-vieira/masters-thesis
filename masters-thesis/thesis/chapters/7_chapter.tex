...
\subsection{Lessons Learned}\label{subsection:lessons_learned}

Tackling privacy issues in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems more complex than initially though.
...
method and apply to \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices as these have different physical shapes and sizes,

...
Another concept worth analysing is differential privacy \DTLassign{acronyms}{6}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) which relates more
...
\subsection{Differential Privacy}\label{subsection:differential_privacy}
...
\DTLassign{acronyms}{6}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} has the potential to significantly increase individual
...
\DTLassign{acronyms}{6}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} algorithms are no exception, they can still help in
regards to tackling technology's intrinsic ethical and moral issues.

Zhao and Chen \cite{ZhaoSurvey} conduct a \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} on \DTLassign{acronyms}{6}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} for
unstructured data. The authors present \DTLassign{acronyms}{6}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} methods for
...
to the conclusion that \DTLassign{acronyms}{6}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} as well as its variations give
...
Integrating federated learning and local differential privacy \DTLassign{acronyms}{15}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) is proposed
...
There have been a number of \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}s \cite{Gupta2022Privacy, Kuhtreiber2022survey, sicari2015security, LinSurvey, yang2022overview, zubaydi2023leveraging}
and systematic mapping reviews \cite{porras2018security, ahmed2019aspects}
done to study privacy and security issues in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}.

In Gupta and Ghanavati's \cite{Gupta2022Privacy} \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, the authors review
...
on single \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices when addressing privacy threats; When analysing privacy
...
difficulties between an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} application and different privacy rules; and
...
and provide threats to the study's validity, however, this \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} has the
...
tools established for developers, specifically in the case of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, and find
that current solutions are difficult to use, only successful in limited
scenarios, and insufficient to handle the privacy problems inherent in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
...
activities that focus on \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy and security solutions. The authors
start by describing the requirements for \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy and security, such
...
came to the conclusion that \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy issues have only been partially
...
a comprehensive summary of future research topics in the area of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy
that require more attention.

Lin et al. \cite{LinSurvey} undertake a literature review to identify security
and privacy vulnerabilities in the three \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} architecture layers: network,
...
and data analysis. The authors do, however, largely focus on the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}'s security
...
of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} phases, such as data collection, transmission, and storage, or in other
...
are analysed. This \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} has an overview of the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} architecture, the various blockchain
types and algorithms and \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} challenges. The authors provide an overview of the
...
smart environments, \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} device gateway, \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} information systems, management systems
and other approaches. The authors also present a considerable number of open issues
that future works should focus on. Because this \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is about blockchain technology,
the focus is on privacy through security. Overall, this is a very in-depth \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} on the
...
literature review on the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. 194 publications have been examined and categorized
...
and privacy. They argue that because \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is evolving quickly, current research
...
applied in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} security, privacy, and trust elements, and the role
...
the future of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, especially since many plan to develop smart cities.
Governments should also ensure that \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} products and solutions are used
...
ethical problems in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. The author concludes that in order to address
sophisticated and tricky unethical and illegal behaviour across the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym},
more specific \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} legislation and ethics norms for \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} need to be devised
and constantly updated.

Based on Ziegeldorf et al. \cite{ziegeldorf2014privacy} analysis of the literature,
the following are the most prominent privacy concerns in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}:
...
\begin{enumerate}
    ...
    medium. \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} applications often need extensive user interaction, it is
    ...
    \item
    \textit{Lifecycle transitions} occur when an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} device is sold, utilized
...
\subsection{Proposed Solutions}\label{subsection:proposed_solutions}
...
Although individuals have a certain expectation of privacy when using \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
...
on privacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} but not many focus on user privacy awareness or
privacy literacy.

Koohang et al. \cite{koohang2022internet} propose a research model with
the goal to examine the relationship between \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} awareness and \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy,
security, and trust, and how this influences \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} continuing usage. To validate
the model, they conducted a study with 299 participants and discovered that
as users increase their awareness of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} security and privacy threats, their
privacy and privacy knowledge increases, and as users become savvier about
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy and security, they place more trust in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices, which affects
their continued intention to use these \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices. Previous publications
...
artificial intelligence \DTLassign{acronyms}{1}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) technology while dealing with a company whistleblower and an untimely
...
of the individual concerned, private information obtained by \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices
...
individual. Before regulations like the \DTLassign{acronyms}{9}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, \DTLassign{acronyms}{3}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} or the Artificial Intelligence
Act, some papers such as Weber \cite{weber2010internet} and Ziegeldorf et al. \cite{ziegeldorf2014privacy}
urged for better regulations to protect personal privacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems.
...
present initiatives aimed at establishing an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} regulatory and legislative
framework in the European Union \DTLassign{acronyms}{8}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}), as well as its pertinence in developing nations, the authors
choice to focus on \DTLassign{acronyms}{8}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is due to \DTLassign{acronyms}{8}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}'s claim for becoming a global leader \cite{european2021europe}. The authors
identify three steps toward the development of an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} regulatory and
legislative framework. The first step is to develop a national \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} strategy, which
is an important blueprint for increasing \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} adoption and should be developed
in accordance with a country's strategic priorities. To that end, a proactive
information and communications technology \DTLassign{acronyms}{10}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) regulator could initiate and encourage
national \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} strategy development. The second step in developing a regulatory
framework for \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} involves the consideration of various aspects of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and navigating through many overlapping policy areas to determine the rules.
The legislation must be designed to be future-proof and not restrict technological
development. The \DTLassign{acronyms}{10}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} regulator, which plays a central role in improving innovation
and developing the electronic communications market, could also play a central role
in the context of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. It could serve as a coordinating authority within
an advisory committee before the establishment of a national supervisory authority
for \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. The new regulatory framework should be prepared and assessed using the
\DTLassign{acronyms}{24}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} (Regulatory Impact Assessment) method to select the best option for the country. And the
third step in the development of a regulatory framework for \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} involves
...
Motivated by privacy concerns in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, Xiong et al. \cite{xiong2018defending}
propose a locally differentially private packet obfuscation mechanism as
a defence against packet-size side-channel assaults in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} networks. Because
a quantifiable measure of privacy risk was required for preserving privacy,
the authors chose \DTLassign{acronyms}{15}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} in order to protect individual
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices given that it could mask packet sizes prior to transmission.
The effectiveness of hiding the packet size from various smart home \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
devices was empirically demonstrated, and it was also clear that this mechanism
works really well when using high bandwidth, but many \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices purposefully
...
\subsubsection{Architecture / Frameworks}\label{subsubsection:architecture_frameworks}

Antunes et al. \cite{AntunesFederated} do a \DTLassign{acronyms}{26}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} on federated learning in
...
ontology for modelling \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} security and privacy policies, a notation for
representing and validating \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} security and privacy policies, a set of
guidelines and rules for detecting \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} policy errors, and a tool for visually
modelling and capturing \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} security policies and discovering policy problems.
...
A Privacy by Design \DTLassign{acronyms}{22}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) framework is proposed by Perera et al. \cite{perera2020designing}
to assist software developers in incorporating concerns about data privacy
into the design of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} applications. The proposed framework consists in
...
related works, they state that various \DTLassign{acronyms}{22}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} frameworks exist, but none are dedicated
to \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, which is incorrect as evidenced by other works \cite{o2017privacy, cavoukian2016embedding},
with \cite{alkhariji2023semantics, aljeraisy2021privacy} being more recent
examples. It is true, however, that there are relatively few \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} \DTLassign{acronyms}{22}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} frameworks.

Q. Zhang et al. \cite{zhang2017privacy} propose a double-projection deep
computation model \DTLassign{acronyms}{7}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) and a privacy-preserving \DTLassign{acronyms}{21}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) variant for
big data feature learning. The \DTLassign{acronyms}{7}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} extends the deep computation model
\DTLassign{acronyms}{5}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) by replacing all hidden layers with double-projection layers.
...
so to solve this problem the authors propose a \DTLassign{acronyms}{21}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} by using the BGV
scheme to encrypt the private data. After testing the proposed models,
they conclude that the \DTLassign{acronyms}{7}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is marginally better than the conventional \DTLassign{acronyms}{5}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
with a 3\% to 4\% improvement, but the \DTLassign{acronyms}{21}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} performs similar to \DTLassign{acronyms}{7}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
without a noticeable classification accuracy drop while still preserving
individual's private data.

There exist frameworks like the \DTLassign{acronyms}{18}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Cybersecurity Framework \cite{barrett2018framework},
published by the National Institute of Standards and Technology \DTLassign{acronyms}{18}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}),
...
Organization for Standardization \DTLassign{acronyms}{12}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}), is a standard that provides
guidelines on risks, principles and safeguards for the security and
privacy of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems. In addition, \DTLassign{acronyms}{12}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} has produced about 208 privacy-related
...
but there may be some overlap between these standards. Even those \DTLassign{acronyms}{12}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy-based
...
Blockchain is an option to guarantee privacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} because of zero-knowledge
...
file sharing with blockchain smart contracts to offer \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} users control
over their data and do away with the necessity for centralized \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} data
...
very few are made for devices in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}.

The Carnegie Mellon University CyLab, which is the university's security
and privacy research institute, started developing in 2019 an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Infrastructure
that intended to be free of privacy leaks and software covered by their
Secure and Private \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Initiative 2019, this project would fall under
their main research theme of Trust. In this project the researchers started the design
of a Personalized Privacy Assistant \DTLassign{acronyms}{20}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) \cite{ColnagoInforming}, this
would involve the use of semi-structured interviews with 17 participants
to examine user perceptions of three hypothetical \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} implementations,
...
three sections: exploratory, anchoring and the \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}; While the exploratory
phase's purpose was to learn about participants' attitudes and understanding
of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, the anchoring phase aimed to normalize participants' basic understanding
of how \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} functions. In order to get people to think about potential privacy
concerns towards the end of the anchoring section, the authors asked participants
about their opinions on data privacy. In the \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} section, it was proposed
the idea of a \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} for \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} as a potential future project. The authors clarified
that the \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} could distinguish between active data requests such as a gadget
...
and Auto implementations of an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} were the three that the authors and
attendees discussed. Notification \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}s can determine which adjacent devices
...
\DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}s, recommendation \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}s offer advice to individuals on how to share their data
based on their preferences. The user's data sharing decisions would be made
by auto \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}s. This would lessen the cognitive load on individuals but also
...
and the lack of agreement regarding the optimal \DTLassign{acronyms}{20}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} implementation.

After the design phase, the institute implemented a privacy assistant \DTLassign{acronyms}{19}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) \cite{FengDesign},
the authors called it \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant. Because the predominant approach of
``notice and choice'' for data privacy protection, they decided the \DTLassign{acronyms}{19}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} would
...
privacy decisions should not be subject to manipulation or bias). The \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
...
options are more effective in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} environment. The \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant acts
...
in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. The three \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} system discovery modes that the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant supports
...
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices and the privacy options they have. Additionally, the united
viewpoint of the integrated notification and option in the the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant
gives succinct yet thorough information regarding \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} data practices to
...
in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant without bias or framing, attempting to offer individuals
a neutral space to execute their privacy choices. Although the authors view
the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} Assistant as a significant step towards ``meaningful privacy options''
in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, this assistant still has many problems, such as the fact that it
...
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} infrastructure that was created before, and as such it is not capable
of identifying new \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices without the end users themselves create on
...
privacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems is that many systems do not offer any type of privacy
...
The \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} infrastructure that was developed \cite{DasPersonalized} is built
on an open, distributed design that allows for the deployment and management
of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} resources to be carried out by any number of actors. Part of this
...
\subsubsection{Other Proposals}\label{subsubsection:other_proposals}

Zhu et al. \cite{ZhuIntegrating} present a hybrid sensor system that safeguards
privacy while also monitoring parking availability. The authors merged \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
sensing with crowdsensing and enhanced it with privacy-preserving methods.
The authors employed physical hazy filters to mask \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} sensors,
...
Lola et al. \cite{electronics12122589} propose a system that manages \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
device network communication by having manufacturers declare their device's
data collection intentions while simultaneously allowing \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} users control
over their data privacy and security, and thus providing transparency to
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems. The system's design includes tools for analysing packets sent
by \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices and executing network traffic control rules. The goal is
to enable the declaration and verification of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} device communication
...
in \DTLassign{acronyms}{29}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}/\DTLassign{acronyms}{11}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} networks, and end-users' inability to adequately establish
...
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} sniffers are usually used to detect problems in the networks, they rarely
...
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is a composed of a complex web of architectures, applications and technologies.
...
objects and components via smart devices (\DTLassign{acronyms}{23}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, sensors, actuators, and
so on). Its key objectives are to connect objects to the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} network and
...
an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} architecture that can use various networks and have the various
devices communicate with each other, even though interoperability is seen
as a very important factor in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. Some of these networks are open standard
...
creating an \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} architecture the designers often think of how to solve
specific problems and use what is best for the current needs, and the way
that \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} is fragmented does not help in providing progress.
...
atoms in space \cite{petrucci2023general}. The design of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} structures lacks
mathematical foundations and is based on empirical methods, which hinders
the development of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. Optimizing \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} performance based solely on human experience
...
and system integration. Ensuring effective \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} applications without wasting resources
...
anonymity in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}. This anonymity needs to be guaranteed at various stages,
...
authors identify five major stakeholders: device manufacturers, \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} cloud services
...
developers with programming interfaces. \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} cloud services and platform providers
...
to the data collected by \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices. Government and regulatory bodies should be
responsible for the enforcement of standardization and legal efforts, while also
allowing interoperability among different \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} solutions, a fair marketplace,
and competition. The authors suggest a governing body similar to the World Wide
Web Consortium for the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} to oversee standardization and certification processes
and that the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} certification model should be much broader because it might need
to certify both hardware products and software services.
The majority of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems currently in use are primarily geared toward users,
although some \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} system types can also have an impact on non-users. The authors
suggest using notifications that are similar to closed-circuit television \DTLassign{acronyms}{4}{\acronym=Acronym}(\hyperlink{\acronym}{\acronym}) surveillance in public spaces,
...
outside the context of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}, similar to the studies on the privacy paradox.

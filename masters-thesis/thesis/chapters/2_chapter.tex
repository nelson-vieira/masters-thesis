...
the authors chose local differential privacy in order to protect individual
...
This chapter discussed many works that proposed various approaches to address
privacy challenges in the IoT. Different aspects of the included papers are now
examined, including their general information, purpose, intended application, future
research or outstanding issues, and lastly additional remarks for consideration.
The conclusions reached here are completely based on the findings of the studies
mentioned.
...
declining since then, at least until 31 August of 2023 there have been
...
\begin{figure}
    \begin{center}
        ...
        \begin{tikzpicture}
            ...
            \end{axis}
        \end{tikzpicture}
        \caption{Distribution of papers, per year since 2010, on privacy in the Internet of Things, searched on Google Scholar database.}
        \label{fig:iotprivacy_papers}
    \end{center}
\end{figure}

In Figure \ref*{fig:privacy_keywords_papers} it is represented the number of papers by topic,
all papers still related to the main topic of privacy in the IoT, in various databases,
namely Google Scholar, BASE and CORE. This data is from papers since 2020, the database
with the most papers is Google Scholar followed by the distant second BASE and finally
CORE with the smallest number of papers. Other databases were used in course of the research
like Semantic Scholar, Baidu Scholar and RefSeek but these databases do not have good
filters and/or have a small number of papers. Around 249000 papers exist discussing privacy
...
17738 on CORE and 5600 on BASE.
    ...
    \begin{center}
        \begin{tikzpicture}
            \begin{axis}[
                ...
                xbar,
                xmin=0,
                symbolic y coords={Privacy in the IoT,Privacy paradox in the IoT,Differential privacy in the IoT,Machine learning and privacy in the IoT,Deep learning and privacy in the IoT,Blockchain and privacy in the IoT,Security and privacy in the IoT,Privacy framework/architecture in the IoT},
                ytick=data,
                yticklabels={
                    Privacy\\in the IoT,

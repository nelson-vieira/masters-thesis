...
There have been a number of systematic literature reviews (SLR) \cite{Gupta2022Privacy, Kuhtreiber2022survey, sicari2015security, LinSurvey, yang2022overview, zubaydi2023leveraging}
...
% images, audio, videos, and texts. Differential privacy has emerged as a de facto
...
% not change their behaviour, one member said that it took more care of The
...
% visually modelling and capturing IoT security policies and discovering
% policy problems.

% This paper's main contributions are: a domain-specific ontology for modelling
...
% detecting IoT policy errors, and a tool for visually modelling and capturing
% IoT security policies and discovering problems with the policies.

% The key contributions of this paper include (1) A domain-specific ontology for modelling IoT security and privacy policies, (2) a notation for representing IoT security and privacy policies and validating the policies for inconsistencies, conflicts, ambiguities, and incompleteness, (3) a set of guidelines and rules for detecting IoT policy errors, and 4) a tool for visually modelling and capturing IoT security policies and discovering problems with the policies.
...
\begin{footnotesize}
    \begin{longtable}{p{1.2cm} p{1cm} p{1.5cm} p{3.2cm} p{5cm} p{3cm}}
        ...
        \hline
        \endfirsthead
        \multicolumn{6}{@{}l}{continued\dots}\\\hline
        \textbf{Ref $\#$} & \textbf{Year} & \textbf{Country} & \textbf{Publication Type} & \textbf{Publisher} & \textbf{Domain} \\
        \hline
        \endhead
...
all collected and analysed. The privacy of consumers is jeopardized if

...
on particular networks, like ZigBee or Bluetooth LE, namely \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} sniffers
and there exist some georeferencing applications that try to pinpoint certain
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices, there is still a need for some kind of device or framework
that is network agnostic and can detect where the devices are located and
what kind of data the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} devices that are around it are collecting. This
...
The \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} sniffers that are available are primarily used in the detection
of problems in the communication of devices in the network or to solve problems
of interoperability between different \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} networks. There are many obstacles
...
fields, such as security and \DTLassign{acronyms}{1}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} while others are left unexplored.

A research path that is underdeveloped is privacy literacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems,
while privacy is explored along with security and other adjacent fields, this aspect of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}
...
Another aspect of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} that deserves more attention
is the application of privacy in the design and development phases of new
\DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems. There are many constraints to take into account when creating a
...
Interoperability is considered to be very important in the \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym},
...
be ever present in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym}.

To summarize, these are the characteristics of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} that deserve more attention:

\begin{itemize}
    \item[$\bullet$]
    Privacy literacy in \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems;
    \item[$\bullet$]
    Application of privacy in the design/development of \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} systems;
    \item[$\bullet$]
    Interoperability standards;
    \item[$\bullet$]
    User-centric approaches to \DTLassign{acronyms}{14}{\acronym=Acronym}\hyperlink{\acronym}{\acronym} privacy.
\end{itemize}
